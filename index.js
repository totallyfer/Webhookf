...
// URL do Webhook do teu Discord configurada
...
// Cookie da tua conta alt (.ROBLOXSECURITY)
...
// Place ID do Flee the Facility (893973440) e o ID do teu Servidor Privado (VIP)
const PLACE_ID = 893973440;
const TARGET_SERVER_ID = "32869743754141535392416901453380";

let lastPlayerCount = -1;

async function checkPrivateServer() {
    try {
        const response = await axios.get(`https://games.roblox.com/v1/games/${PLACE_ID}/servers/Private/${TARGET_SERVER_ID}`, {
            headers: {
